...
- \ThisULCornerWallPaper{1}{"`r DocRR::Lake_report()`"}
#-----------------------END-------------------------------------#
output:
...
#-------Make sure to comment out everything below if using word or html above-----#
  bookdown::pdf_document2:
    keep_tex: no #Only have true if you want to keep the latex file produced
    latex_engine: xelatex #Has to be xelatex to use Archer fonts
    template: doc_report_with_cover_page.tex #Don't change this!!!
