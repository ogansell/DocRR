...
R markdown enables this through using R code directly in your text. Code results can be inserted directly into the text of a ``.Rmd`` file by enclosing the code with `r`. 
